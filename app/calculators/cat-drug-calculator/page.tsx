    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { name: 'Cat drug calculator', href: '/calculators/cat-drug-calculator/' },
        ]}
      />
      ...
      <div className="mt-6 grid gap-10 lg:grid-cols-[minmax(0,1fr)_380px]">
        <aside className="order-1 lg:order-2 lg:col-start-2 lg:row-start-1 lg:sticky lg:top-24 h-fit">
          <form onSubmit={run} className="rounded-2xl border border-ink-200 bg-white p-6 shadow-card">
            ...
            <h2 className="font-serif text-xl text-ink-900">Cat dose calculator</h2>

            <label className="mt-5 block">
              <span className="text-xs font-medium text-ink-700">Cat weight</span>
        ...
        <div className="order-2 lg:order-1 lg:col-start-1 lg:row-start-1 max-w-3xl">
          ...
          <p className="mt-5 text-lg text-ink-700 leading-relaxed">
            A cat dosage calculator for the standard veterinary dose math. Enter your cat
...
{`total dose (mg) = dose rate (mg/kg) x cat weight (kg)
volume (mL)     = total dose (mg) / concentration (mg/mL)`}
          ...
          <section className="mt-10">
            ...
            <div className="mt-4 rounded-2xl border border-ink-200 bg-white p-6 text-ink-700">
              <p>A 4 kg cat with a 2 mg/kg dose rate and a 10 mg/mL product:</p>
              <p className="mt-2 font-mono text-ink-900">
                total dose = 2 x 4 = 8 mg
                <br />
                volume = 8 / 10 = 0.8 mL
              </p>
            </div>
          ...
          <section className="mt-10">
            <h2 className="font-serif text-2xl text-ink-900">Notes for cat dosing</h2>
            <ul className="mt-4 space-y-2 text-ink-700 leading-relaxed list-disc pl-6">
              <li>Cats have species-specific drug sensitivities that differ from dogs.</li>
              <li>Always confirm the dose rate against a veterinary reference for cats.</li>
              <li>
                See{' '}
